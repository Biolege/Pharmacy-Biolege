...
import 'viewDetailsBScreenViewModel.dart';

class ViewDetailsBScreenView extends StatelessWidget {
  static const String routeName = "/ViewDetailsBScreenView";
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ViewDetailsBScreenViewModel>.reactive(
      viewModelBuilder: () => ViewDetailsBScreenViewModel(),

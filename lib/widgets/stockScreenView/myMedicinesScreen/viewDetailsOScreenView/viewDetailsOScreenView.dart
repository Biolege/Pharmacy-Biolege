...
import 'viewDetailsOScreenViewModel.dart';

class ViewDetailsOScreenView extends StatelessWidget {
  static const String routeName = "/ViewDetailsOScreenView";
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ViewDetailsOScreenViewModel>.reactive(
      viewModelBuilder: () => ViewDetailsOScreenViewModel(),

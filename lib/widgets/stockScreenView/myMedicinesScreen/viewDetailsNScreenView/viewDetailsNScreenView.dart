...
import 'viewDetailsNScreenViewModel.dart';

class ViewDetailsNScreenView extends StatelessWidget {
  static const String routeName = "/ViewDetailsNScreenView";
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ViewDetailsNScreenViewModel>.reactive(
      viewModelBuilder: () => ViewDetailsNScreenViewModel(),

...
class ViewDetailsB extends StatelessWidget {
  ...
  Widget _buildMedicinedetails(){
    return Container(
                ...
                Text('Biolege',style: TextStyle(
                      ...
                      Row(
                        children: [
                          Text('Buy 2 Box, Get 1 box free',style: TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.w300,
                      color: Colors.grey
                       ),),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('Buy 3 Box, Get 2 box free',style: TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.w300,
                      color: Colors.grey
                       ),),
  ...
  Widget _buildInstockDetails(){
    return Container(
                ...
                child: Padding(
                  ...
                  SizedBox(width: 15,),
                  Text('10 July 2020',style: TextStyle(
                    fontSize: 15,
                    color: Colors.black,
                    fontWeight: FontWeight.w300
                  ),),

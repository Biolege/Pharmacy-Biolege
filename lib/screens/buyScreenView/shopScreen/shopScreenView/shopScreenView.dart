...
class ShopScreenView extends StatelessWidget {
  static const String routeName = "/ShopScreenView";
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [Text('Cadilla Zydus'), Icon(Icons.gavel)],
                ),
                SizedBox(
                  height: 10,
                ),
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ShopScreenViewModel>.reactive(
      viewModelBuilder: () => ShopScreenViewModel(),

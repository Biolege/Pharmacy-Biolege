...
import 'onlineOrderDetailsScreenViewModel.dart';

class OnlineOrderDetailsScreenView extends StatelessWidget {
  static const String routeName = '/OnlineOrderDetailsScreenView';
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<OnlineOrderDetailsScreenViewModel>.reactive(
      viewModelBuilder: () => OnlineOrderDetailsScreenViewModel(),
                    ...
                    Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(
                            left: 15, right: 5, top: 10, bottom: 15),
                        child: Column(
                          children: [
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,

...
class CheckItemsScreenView extends StatelessWidget {
  static const String routeName = '/CheckItemsScreenView';
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<CheckItemsScreenViewModel>.reactive(
      viewModelBuilder: () => CheckItemsScreenViewModel(),
